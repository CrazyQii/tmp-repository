...
export interface SunburstSeriesNodeItemOption extends SunburstStateOption<CallbackDataParams>,
...
export interface SunburstSeriesOption extends SeriesOption<SunburstStateOption, SunburstStatesMixin>, SunburstStateOption,
    SunburstColorByMixin,
    CircleLayoutOptionMixin {
