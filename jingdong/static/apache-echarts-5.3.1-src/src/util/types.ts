...
export interface ECElementEvent extends ECEventData,
    CallbackDataParams {
...
export type OptionSourceData<VAL extends OptionDataValue = OptionDataValue,
...
export type OptionDataItemOriginal<VAL extends OptionDataValue = OptionDataValue> =
    VAL
    | VAL[]
    | OptionDataItemObject<VAL>;
export type OptionSourceDataOriginal<VAL extends OptionDataValue = OptionDataValue,
    ORIITEM extends OptionDataItemOriginal<VAL> = OptionDataItemOriginal<VAL>> = ArrayLike<ORIITEM>;
...
export interface SeriesOption<StateOption = unknown,
    StatesMixin extends StatesMixinBase = DefaultStatesMixin> extends ComponentOption,
