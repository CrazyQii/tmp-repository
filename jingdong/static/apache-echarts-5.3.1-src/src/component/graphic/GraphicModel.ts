...
interface GraphicComponentBaseElementOption extends Partial<Pick<Element, TransformProp |
    'silent' |
    'ignore' |
    'textConfig' |
    'draggable' |
...
export interface GraphicComponentDisplayableOption extends GraphicComponentBaseElementOption,
