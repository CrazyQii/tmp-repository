...
// api接口
import { flight_api, user_api, pay_api } from './utils/api.js'
...
Vue.component(Steps.Step.name, Step.Step)
...
//定义全局变量
Vue.prototype.$flight_api = flight_api;
Vue.prototype.$user_api = user_api;
Vue.prototype.$pay_api = pay_api;
